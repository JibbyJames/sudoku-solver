...
public class DefaultCellStyle extends CellStyle
{
    public DefaultCellStyle(Context context)
    {
        super(context);
    }
    ...
    {
        return context.getResources().getColor(R.color.cell_selected);
    }

    @Override
    public int getBackgroundDefault()
    {
        return context.getResources().getColor(R.color.cell_default);
    }
    ...
    {
        return context.getResources().getColor(R.color.cell_incorrect_font);
    }
}
